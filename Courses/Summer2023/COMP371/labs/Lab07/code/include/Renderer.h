...
enum ShaderType { SHADER_SOLID_COLOR, SHADER_TEXTURE };
...
class Renderer {
 public:
  ...
  static GLuint LoadShaders(std::string vertex_shader_path,
                            std::string fragment_shader_path);

  static unsigned int GetShaderProgramID() {
    return sShaderProgramID[sCurrentShader];
  }
