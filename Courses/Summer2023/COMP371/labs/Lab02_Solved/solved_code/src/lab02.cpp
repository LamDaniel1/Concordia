...
int main(int argc, char*argv[])
{
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        // NOTE: Added to demonstrate distance
        glm::mat4 translationMatrix = glm::translate(glm::mat4(1.0f), glm::vec3(-0.5f, 0.0f, -0.5f));
        ...
        // NOTE: Added to demonstrate distance
        translationMatrix = glm::translate(glm::mat4(1.0f), glm::vec3(0.5f, 0.0f, 0.5f));
        ...
        // Without the negative scaling
        scalingMatrix = glm::scale(glm::mat4(1.0f), glm::vec3(0.25f, 0.25f, 0.25f));
        translationMatrix = glm::translate(glm::mat4(1.0f), glm::vec3(-0.5f, 0.5f, 0.0f));
        worldMatrix = translationMatrix * scalingMatrix;
