...
public class Network extends Thread {
     ...
     * @return
     * @param inPacket
     *            transaction transferred from the client
     * 
     */
     ...
     * @return
     * @param outPacket
     *            updated transaction received by the client
     * 
     */
     ...
     * @return
     * @param outPacket
     *            updated transaction transferred by the server to the network
     *            output buffer
     * 
     */
     ...
     * @return
     * @param inPacket
     *            transaction transferred from the input buffer to the server
     * 
     */
