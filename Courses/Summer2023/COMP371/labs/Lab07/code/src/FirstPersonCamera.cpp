...
FirstPersonCamera::FirstPersonCamera(glm::vec3 position) :  Camera(), mPosition(position), mLookAt(0.0f, 0.0f, 1.0f), mHorizontalAngle(110.0f), mVerticalAngle(-10.0f), mSpeed(5.0f), mAngularSpeed(2.5f)
{
}
